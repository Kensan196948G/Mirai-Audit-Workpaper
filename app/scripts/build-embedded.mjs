// web/dist の index.html と index.production.html を src/embedded-assets.ts に埋め込む
// （通常UIと本番用UIの2系統。手編集禁止・ビルドで自動生成）
...
const productionHtml = readFileSync(join(webDist, "index.production.html"), "utf-8");
...
export const EMBEDDED_INDEX_PRODUCTION_HTML: string = ${JSON.stringify(productionHtml)};
`;
